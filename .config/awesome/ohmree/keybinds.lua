...
keybinds.globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "w", function () widgets.mainmenu:show() end,
...
for i = 1, 9 do
    keybinds.globalkeys = gears.table.join(keybinds.globalkeys,
        -- View tag only.
...
keybinds.tasklist_buttons = gears.table.join(
                     awful.button({ }, 1, function (c)
...
keybinds.taglist_buttons = gears.table.join(
